...
import com.example.stonefengshuimanagement.exception.ExceptionUtil;
...
public class CategoryDAO {
    ...
    private void mapRow(List<Category> categories, ResultSet rs) throws SQLException {
        while (rs.next()) {
            int id = rs.getInt("id");
